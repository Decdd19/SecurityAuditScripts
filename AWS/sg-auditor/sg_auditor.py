...
def write_html(report, path):
    ...
    for f in findings:
        ...
        <tr>
            ...
            <td style="font-size:0.8em;color:#dc3545">{ports_html}</td>
...
<div class="summary">
  ...
  <div class="card" style="border-left:4px solid #dc3545"><div class="num" style="color:#dc3545">{summary['open_ssh']}</div><div class="label">SSH Open to World</div></div>
  ...
  <div class="card" style="border-left:4px solid #fd7e14"><div class="num" style="color:#fd7e14">{summary['all_traffic_open']}</div><div class="label">All Traffic Open</div></div>
