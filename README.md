...
**Flags:** `--aws` · `--linux` · `--all` · `--ssl` · `--http-headers` · `--email` · `--domain` · `--profile` · `--regions` · `--output` · `--workers` · `--open`
...
**Flags:** `-Azure` (11) · `-M365` (6) · `-Windows` (8) · `-All` · `-AllSubscriptions` · `-OutputDir` · `-SkipSummary` · `-Open`
